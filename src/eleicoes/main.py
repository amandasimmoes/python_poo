...
def menu_candidato():
    ...
    print("3-Sair")
    op_user = int(input("Digite a opcao [1,2,3]? "))
    while op_user not in (1, 2, 3):
        op_user = int(input("Digite a opcao [1,2,3]? "))
    return op_user
...
def listar_candidato(candidato):
    for c in candidato.values():
        print(c)
...
if __name__ == "__main__":
    ...
    while op_user not in (1,2):
        op_user = int(input("Gerenciar 1- Eleitor OU 2-Candidato: "))
